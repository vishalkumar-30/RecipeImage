...
def predict():
    ...
    image_path = os.path.join('C:/Users/pragya/Downloads/Recipe-Generation-from-Food-Image-main/Recipe-Generation-from-Food-Image-main/Foodimg2Ing/static/images/demo_imgs', imagefile.filename)
